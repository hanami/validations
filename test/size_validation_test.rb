  ...
  describe 'size' do
    ...
    it "isn't valid if the size doesn't match" do
      ...
      values.each do |value|
        ...
        errors.must_include Lotus::Validations::Error.new(:ssn, :size, 11, value, 'size_validator_test')
      end
    end
    ...
    it "isn't valid if the size isn't included in the given range" do
      ...
      values.each do |value|
        ...
        errors.must_include Lotus::Validations::Error.new(:password, :size, 9..56, value, 'size_validator_test')
      end
    end
